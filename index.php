...
<main>
    ...
    <div class="app-grid">
        <a href="apps/acronimo.php" class="app-card">
            ...
            <p>Convierte una palabra larga en su acrónimo o encuentra las letras iniciales y acepta guiones y espacios como separadores.</p>
        </a>
        <a href="apps/fibonacci.php" class="app-card">
            <span class="num">02</span>
            <h3>Fibonacci / Factorial</h3>
            <p>Calcula la sucesión de el factorial y el Fibonacci de un número y muestra la serie completa.</p>
        </a>
        <a href="apps/estadistica.php" class="app-card">
            <span class="num">03</span>
            <h3>Estadística</h3>
            <p>Calcula la media, la moda y la mediana de unos números reales ingresados.</p>
        </a>
        <a href="apps/conjuntos.php" class="app-card">
            <span class="num">04</span>
            <h3>Operaciones de Conjuntos</h3>
            <p>Dados dos conjuntos X y Y, se calcula la unión, intersección, la diferencia(X-Y y Y-X).</p>
        </a>
        <a href="apps/binario.php" class="app-card">
            <span class="num">05</span>
            <h3>Conversor a Binario</h3>
            <p>Convierte un número entero a su representación en sistema binario (base 2).</p>
        </a>
        <a href="apps/arbol.php" class="app-card">
            <span class="num">06</span>
            <h3>Árbol Binario</h3>
            <p>Construccion y visualizacion de un árbol binario a partir de dos recorridos: preorden, inorden o postorden.</p>
        </a>
        <a href="apps/calculadora.php" class="app-card">
            <span class="num">07</span>
            <h3>Calculadora</h3>
            <p>Calculadora con operaciones básicas: suma, resta, multiplicación, division y porcentaje. Ademas guarda historial.</p>
        </a>
    </div>
</main>
